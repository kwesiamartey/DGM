...
class WebsiteFragment : Fragment() {
    ...
    lateinit var _bind :FragmentWebsiteBinding
    val view get() = _bind
    ...
    override fun onCreateView(
        ...
        _bind =  FragmentWebsiteBinding.inflate(layoutInflater)
        ...
        mWebView.loadUrl("http://www.dgmfaithlifetemple.com")        // Force links and redirects to open in the WebView instead of in a browser
